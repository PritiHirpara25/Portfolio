...
export default function About() {
  return (
    <div id='about'>
      ...
      <div className="grid grid-cols-3 gap-8 py-24 text-white">
        <div className="flex flex-col justify-center">
          ...
          <a href='/CV/Priti_Hirapara_CV.pdf' download={'Priti_Hirapara_CV.pdf'} target='_blank'>
            <button className="px-6 py-3 cursor-pointer bg-[#1e1e1e] text-white rounded-md shadow-[-6px_-6px_12px_rgba(255,255,255,0.05),6px_6px_12px_rgba(0,0,0,0.6)]">
              Download CV
            </button>
          </a>
        </div>
        ...
        <div>
          <img src={home} alt='about image' className='rounded-2xl border h-[500px] w-full' />
        </div>
